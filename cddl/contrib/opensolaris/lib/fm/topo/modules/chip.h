...
extern int
_topo_init(topo_mod_t *);
extern void
_topo_fini(topo_mod_t *);
...
extern int add__strprop(topo_mod_t *, tnode_t *,
    const char *, const char *, const char **);
extern int add_longprop(topo_mod_t *, tnode_t *,
    const char *, const char *, int32_t *);
extern int add__longprops(topo_mod_t *, tnode_t *,
    const char *, int32_t *, ...);
